/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 234c129a72692d7f42881630ff59df88)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	UPSTREAM_BASE_URL: "https://agent.vlm.run/v1";
	CHAT_COMPLETIONS_URL: "https://agent.vlm.run/v1/openai/chat/completions";
	MODEL_ENDPOINT: "https://agent.vlm.run/v1/openai/models";
	DEFAULT_MODEL: "vlmrun-orion-2:opus-5";
	MODELS: "vlmrun-orion-2:opus-5";
	CORS_ORIGIN: "*";
	VLM_TOOLSETS: "core,document,image,image-gen,video,viz,web,world-gen";
	VLM_PREVIEW: "true";
	VLM_ORIGIN: "https://chat.vlm.run";
	VLM_REFERER: "https://chat.vlm.run/";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_BASE_URL" | "CHAT_COMPLETIONS_URL" | "MODEL_ENDPOINT" | "DEFAULT_MODEL" | "MODELS" | "CORS_ORIGIN" | "VLM_TOOLSETS" | "VLM_PREVIEW" | "VLM_ORIGIN" | "VLM_REFERER" | "UPSTREAM_TIMEOUT_MS" | "MAX_BODY_BYTES">> {}
}
